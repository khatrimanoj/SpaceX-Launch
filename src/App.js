...
export default class javascriptMap extends Component {
  ...
  yearDataFilter = (year) => {
    const items = this.state.allData.filter(
  ...
  launchFilter = (launch) => {
    const items = this.state.allData.filter(
      (item) => item.launch_success === launch
    );
    this.setState({ items });
  };
  landFilter = (landing) => {
    const items = this.state.allData.filter(
      (item) => item.launch_landing === landing
    );
    this.setState({ items });
  };
  ...
  render() {
    ...
    return (
      <div className="container">
        <nav className="site_name">
          <h2>SpaceX Launch Programes</h2>
        </nav>
        <div className="content_wrapper">
          <aside>
            ...
            <div className="launch__year">
              <h3>Launch Year</h3>
              <ul>
                <li className={this.state.active ? "active" : "activeted"}>
                  <a href="#" onClick={() => this.yearDataFilter("2006")}>
                    2006
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2007")}>
                    2007
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2008")}>
                    2008
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2009")}>
                    2009
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2010")}>
                    2010
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2011")}>
                    2011
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2012")}>
                    2012
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2013")}>
                    2013
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2014")}>
                    2014
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2015")}>
                    2015
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2016")}>
                    2016
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2017")}>
                    2017
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2018")}>
                    2018
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2019")}>
                    2019
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.yearDataFilter("2020")}>
                    2020
                  </a>
                </li>
              </ul>
            ...
            <div className="launch__success">
              ...
              <ul>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.launchFilter(true)}>
                    True
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.launchFilter(false)}>
                    False
                  </a>
                </li>
              </ul>
            ...
            <div className="landing__success">
              ...
              <ul>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.landFilter(true)}>
                    True
                  </a>
                </li>
                <li className={this.state.active ? "active" : null}>
                  <a href="#" onClick={() => this.landFilter(false)}>
                    False
                  </a>
                </li>
              </ul>
          ...
          <div className="main_body">
            <ul className="tiles" aria-live="polite">
              {this.state.items.length > 0 ? (
                ...
                <div className="error-message">No Data is available</div>
              )}
